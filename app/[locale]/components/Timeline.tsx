...
export default function Timeline() {
    const timelineEvents = [
        ...
        { year: '2002', description: 'Заснування організації у Львові' },
        { year: '2004', description: 'Перший курс' },
        { year: '2007', description: 'Перший ІЯК' },
        { year: '2009', description: 'Перший BEC' },
                ...
                <div className='grid grid-cols-6'>
                    ...
                    <div className='grid grid-rows-2 lg:gap-24 xl:gap-[140px] 2xl:gap-[190px]'>
                        <div className='row-start-1 flex flex-col-reverse items-start'>
                            <span className='text-[28px] xl:text-[36px] text-best-blue font-bold'>2002</span>
                    ...
                    <div className='grid grid-rows-2 lg:gap-24 xl:gap-[140px] -ml-1 2xl:-ml-2 2xl:gap-[190px]'>
                        <div className='row-start-2 flex flex-col items-start'>
                            <span className='text-[28px] xl:text-[36px] text-best-blue font-bold'>2004</span>
                    ...
                    <div className='grid grid-rows-2 lg:gap-24 xl:gap-[140px] -ml-3 2xl:-ml-4 2xl:gap-[190px]'>
                        <div className='row-start-1 flex flex-col-reverse items-start'>
                            <span className='text-[28px] xl:text-[36px] text-best-blue font-bold'>2007</span>
                    ...
                    <div className='grid grid-rows-2 lg:gap-24 xl:gap-[140px] -ml-5 2xl:-ml-6 2xl:gap-[190px]'>
                        <div className='row-start-2 flex flex-col items-start'>
                            <span className='text-[28px] xl:text-[36px] text-best-blue font-bold'>2009</span>
